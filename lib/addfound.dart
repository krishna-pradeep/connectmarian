...
class AddFoundScreen extends StatefulWidget {
  @override
  _AddFoundScreenState createState() => _AddFoundScreenState();
}

class _AddFoundScreenState extends State<AddFoundScreen> {
  ...
  Future<void> _saveItem() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Found item added successfully")),
      );
          ...
          child: Column(
            ...
            children: [
              ...
              buildFormField(
                ...
                hint: "Ask a question to verify the true owner",
